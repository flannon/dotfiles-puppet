...
[[ $OSNAME == Fedora ]] && PACKAGMGR='dnf'

#echo "OSNAME: $OSNAME"
#echo "OSMAJ: $OSMAJ"

#sudo $PACKAGEMGR install https://rpmfind.net/linux/fedora-secondary/releases/29/Everything/s390x/os/Packages/a/ansible-2.6.5-1.fc29.noarch.rpm
#sudo dnf install https://rpmfind.net/linux/fedora-secondary/releases/29/Everything/s390x/os/Packages/a/ansible-2.6.5-1.fc29.noarch.rpm

cd ansible
ansible-galaxy install -r requirements.yml
ansible-playbook -i ./inventory playbooks/hopper.yml
cd -
